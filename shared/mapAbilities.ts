...
export default {
    ...
    [GAME_ATTACKS.TANK_UP]: () => ({
        ...
        cost: 1,
        power: 0,
        description: "Gain 1 Defense and 5 Max Health",
        isUltimate: false,
        healthGain: 5,
        defenseGain: 1,
        priority: 0,
    ...
    [GAME_ATTACKS.ASSASSINATE]: () => ({
        ...
        cost: 5,
        power: 4,
        description: "Damage the opponent for 400% Character Power, +2 Priority.",
        isUltimate: true,
    ...
    [GAME_ATTACKS.RECUPERATE]: () => ({
        ...
        cost: 0,
        power: 0,
        description: "Heal for 10 and gain 2 Energy",
        isUltimate: false,
        isStatic: true,
        healAmount: 10,
        energyGain: 2,
    ...
    [GAME_ATTACKS.METEOR]: () => ({
        ...
        power: 1.5,
        teamPower: 0.5,
        description: "Damage the opponent for 200% Power, and all other enemy team members for 50% Player Power",
        isUltimate: true,
        priority: 0,
    ...
    [GAME_ATTACKS.FROST_ARMOUR]: () => ({
        ...
        cost: 2,
        power: 0,
        description: "Gain 4 Defense, but lose 2 Speed",
        isUltimate: false,
        priority: 0,
        defenseGain: 4,
        speedGain: -2,
    ...
    [GAME_ATTACKS.CURSE]: () => ({
        ...
        cost: 1,
        power: 0,
        description: "Lower your opponent's Power, Energy, Defense and Speed by 1",
        isUltimate: false,
        priority: 0,
        statChange: -1,
        type: ATTACK_TYPES.STATUS,
    ...
    [GAME_ATTACKS.BLOOD_MOON]: () => ({
        ...
        cost: 2,
        power: 0,
        description: "Damage your opponent for 100% of OPPONENT's Power, ignoring defense",
        isStatic: true,
        isUltimate: false,
        priority: 0,
        type: ATTACK_TYPES.DEATH,
